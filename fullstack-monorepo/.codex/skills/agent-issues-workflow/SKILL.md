...
<!-- TODO: specify how issues are stored and fetched for this project, e.g.:
  "Use `gh issue list --repo <owner/name>` via Bash to fetch open issues."
...
<!-- TODO: if this project uses a shared workflow script, replace the manual loop above with a delegation to it, e.g.:
