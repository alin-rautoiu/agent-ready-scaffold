---
name: Code Review
description: (Claude) Use when reviewing a diff, pull request, branch, or local code changes for bugs, regressions, risks, and missing tests. Returns severity-ranked findings for Orchestrator triage.
