...
- <!-- TODO: link to project-specific frontend design or UX design docs, e.g.: `design/30-frontend-ux.md` -->
- <!-- TODO: link to project-specific coding pattern skills, e.g.: `.claude/skills/repo-patterns/react-patterns.md` -->
