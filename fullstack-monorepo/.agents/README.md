...
- `.agents/skills/`: reusable playbooks for recurring task types
- `.agents/workflows/`: short execution recipes for common flows
...
- For discovery, use `.agents/skills/INDEX.md`.
- For workflow recipes, use `.agents/workflows/INDEX.md`.
