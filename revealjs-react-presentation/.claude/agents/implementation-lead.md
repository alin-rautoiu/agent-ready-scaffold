...
description: (Claude) Use when implementing scoped changes to the presentation scaffold against `docs/deck-plan.md` and returning a structured handoff.
...
2. Read `.claude/skills/repo-patterns/SKILL.md` for the canonical primitives and component catalog.
3. Read `.claude/skills/revealjs-presentation-improvement/SKILL.md` for the "how to build" authority — visual system, layout patterns, QA workflow.
