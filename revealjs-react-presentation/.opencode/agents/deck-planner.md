---
description: Creates or updates `docs/deck-plan.md` — the human-readable spec for the deck. Runs before any slide implementation work.
mode: subagent
permission:
  edit: allow
  read: allow
...
5. Use the `question` tool to confirm layout choices and clarify missing information before writing.
