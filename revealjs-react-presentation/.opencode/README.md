...
OpenCode agent configuration for this presentation scaffold. This directory holds OpenCode-format agent definitions that mirror the canonical agent definitions from `.claude/agents/`.
